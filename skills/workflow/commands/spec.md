...
1. Read the feature description provided: $ARGUMENTS
2. Determine the next spec number by reading `specs/INDEX.md` (start at 0001 if INDEX.md doesn't exist or is empty)
3. Create the spec file at `specs/draft-{NNNN}-{kebab-name}.md` using the template at `specs/_templates/feature-spec.md`
...
6. Print the spec path and a summary
