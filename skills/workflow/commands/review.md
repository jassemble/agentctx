...
2. Determine which spec to review:
   - If argument provided, use that spec path: $ARGUMENTS
   - Otherwise, find in-progress or completed specs from `.agentctx/specs/INDEX.md`
   - Read the spec file and parse its YAML frontmatter to confirm status
